...
func TestCache(t *testing.T) {
    ...
    table := CacheExpireAfterAccess("testCache")
...
func TestCacheKeepAlive(t *testing.T) {
    // add an expiring item
    table := CacheExpireAfterAccess("testKeepAlive")
...
func TestCacheCallbacks(t *testing.T) {
    ...
    table := CacheExpireAfterAccess("testCallbacks")
...
func TestCacheLogger(t *testing.T) {
    ...
    table := CacheExpireAfterAccess("testLogger")
    table.SetLogger(l)
    table.Add(k, 0, v)
